...
public class FormKaryawan extends javax.swing.JPanel {
    ...
    public FormKaryawan() {
        initComponents();
        Connection conn = com.okesalon.util.koneksi.getConnection();
    if (conn == null) {
    ...
    if (selectedKaryawan == null) {
        ...
        try {
            ...
            updated.setKodeKaryawan(selectedKaryawan.getKodeKaryawan()); 
    ...
    if (keyword.isEmpty()) {
        if (isViewGajiMode) {
            btnViewGajiActionPerformed(null); 
        } else {
            loadDataToTable();
        }
        return;
    ...
    tabel_karyawan.getColumnModel().getColumn(0).setPreferredWidth(200); 
    tabel_karyawan.getColumnModel().getColumn(1).setPreferredWidth(150); 
    tabel_karyawan.getColumnModel().getColumn(2).setPreferredWidth(150); 
    tabel_karyawan.getColumnModel().getColumn(3).setPreferredWidth(150); 
