...
public class FormTransaksiPembelianProduk extends javax.swing.JPanel {
    ...
    private void initTable() {
        ...
        // Column widths (adjusted - no Actions column)
        tabel_pembelian.getColumnModel().getColumn(0).setPreferredWidth(150); // No Transaksi
        tabel_pembelian.getColumnModel().getColumn(1).setPreferredWidth(100); // Tanggal
        tabel_pembelian.getColumnModel().getColumn(2).setPreferredWidth(100); // Kode
        tabel_pembelian.getColumnModel().getColumn(3).setPreferredWidth(250); // Nama Produk
        tabel_pembelian.getColumnModel().getColumn(4).setPreferredWidth(200); // Supplier
        tabel_pembelian.getColumnModel().getColumn(5).setPreferredWidth(100); // Jumlah
        tabel_pembelian.getColumnModel().getColumn(6).setPreferredWidth(150); // Total
        ...
        tabel_pembelian.getColumnModel().getColumn(6).setCellRenderer(rightRenderer);
    ...
    private void setupComboBoxKeyReleased() {
        ...
        // ✅ KeyReleased untuk nama_supplier
    ...
    private void filterProdukComboBox(String keyword) {
        ...
        // Disable action listener temporarily to prevent auto-trigger
    ...
    private TransaksiPembelianProduk getTransaksiFromForm() throws Exception {
        ...
        if (nama_supplier.getSelectedIndex() == 0) {
            throw new Exception("⚠️ Pilih supplier!");
        }
        ...
        if (jumlahStr.isEmpty()) {
            throw new Exception("⚠️ Isi jumlah beli!");
        }
        ...
        transaksi.setKodeTransaksi(transaksiPembelianProdukDAO.generateKodeTransaksi());
    ...
    try {
        ...
        // Set metode pembayaran & keterangan
...
tableModel.setRowCount(0);
    ...
    tabel_pembelian.getColumnModel().getColumn(0).setPreferredWidth(250); // Nama
    tabel_pembelian.getColumnModel().getColumn(1).setPreferredWidth(130); // Telepon
    tabel_pembelian.getColumnModel().getColumn(2).setPreferredWidth(150); // Jumlah
    tabel_pembelian.getColumnModel().getColumn(3).setPreferredWidth(150); // Total
    tabel_pembelian.getColumnModel().getColumn(4).setPreferredWidth(200); // Produk
    tabel_pembelian.getColumnModel().getColumn(5).setPreferredWidth(120); // Tanggal
...
// TODO add your handling code here:
    ...
    if (selectedTransaksi == null) {
        ...
        // Fill form dengan data selected
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
